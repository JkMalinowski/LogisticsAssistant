...
namespace LogisticsAssistant.Models
{
    public class Lorries
    {
        ...
        [Required(ErrorMessage = "Break should be grater than 30 minutes!"), DisplayName("Break in minutes"), Range(30, double.MaxValue)]
        public int BreakInMinutes{ get; set; }
        [Required, DisplayName("Required break after certain time in hours")]
